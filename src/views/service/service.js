...
export default class Service extends React.Component {
  ...
  servicesListAPICall(searchText) {
    axios({
      method: "get",
      url: `${configData.SERVER_URL}partner/service/getServices/1/${this.state.pageRecordCount}?search=${searchText}`,
      headers: {
              ...
              >
                ...
                >
                  ...
                  <div x-ref="popperRoot" class={this.state.tacbleAction}>
                    <div class="popper-box rounded-md border border-slate-150 bg-white py-1.5 font-inter dark:border-navy-500 dark:bg-navy-700"></div>
                  </div>
                </div> */}
              </div>
            </div>
                  ...
                  <tbody>
                    {this.state.services.map((service, index) => (
                      <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                          {service?.category_categoryToservice?.name}
                        </td>
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                          {service?.subcategory_serviceTosubcategory?.name}
                        </td>
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                          {service?.price_priceToservice[0]?.pricefrom}
                        </td>
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                          <div
                            x-data="usePopper({placement:'bottom-end',offset:4})"
                          ...
                          >
                            <button
                              ...
                              onClick={() => {
                                if (
                                  document
                                    .getElementById("pooper-" + service.id)
