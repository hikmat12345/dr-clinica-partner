...
export default class AddVoucher extends React.Component{
        ...
        axios({
            ...
            if(parseInt(Object.keys(resp.data)[0]) === 200){
              this.setState({
                ...
                validfor : resp.data.vouchersettings.expirytime,
                onlinesale : resp.data.vouchersettings.onlinesale
              })
            }
        }).catch(err => {
            swal({
    ...
    handleRetailPriceInputChange = (e) => {
        e.preventDefault()
        if(parseInt(this.state.value) > parseInt(e.currentTarget.value)){
            this.setState({
                [e.currentTarget.id] : e.currentTarget.value,
                retailPriceError : false
            })
    ...
    handleValueInputChange = (e) => {
        ...
        console.log("Threshhold",this.state.minthreshhold)
        if(parseInt(e.currentTarget.value) > parseInt(this.state.minthreshhold)){
            console.log("true")
            this.setState({
                [e.currentTarget.id] : e.currentTarget.value,
                retailPriceError : false
    ...
    forwardStep1 = (e) => {
        ...
        // if(!this.state.uplodedImag[0]){  
        //     document.getElementById("btn1").style.border="1px solid red"
        //     return
        // }
        // if (!this.state.uplodedImagmobile[0]){
    ...
    createVoucher = (event) => {
        ...
        const images=[{
             image:this.state.uplodedImag[0],
             device:1
            },{
             image:this.state.uplodedImagmobile[0],
             device:2
            },]
        ...
        bodyFormData.append('voucherImages',  JSON.stringify(images))
        // if(this.state.uplodedImag[0]  && this.state.uplodedImagmobile[0]){
            axios({
                method: "post",
                url: configData.SERVER_URL + 'partner/vouchers/addvoucher',
                data: bodyFormData,
                headers: { 
                    "Content-Type": "application/x-www-form-urlencoded",
                    "accesstoken" : configData.ACCESSTOKEN,
        ...
        <div class="grid grid-cols-1 gap-4 sm:gap-5 lg:grid-cols-2 lg:gap-6">
            ...
            { this.state.step1 ? 
                <div class="card px-4 pb-4 sm:px-5">
                    ...
                    <label class="block">
                        <span>Valid for</span>
                        <select value={this.state.validfor} class="form-select mt-1.5 w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:hover:bg-navy-900 dark:focus:bg-navy-900" id="validfor" onChange={this.handleInputChange}>
                    ...
                    {/* <div class="grid grid-cols-2 gap-4 text-left">
                        ...
                        <div class="  mx-auto"> 
                                ...
                                <button class="btn h-20 min-w-[7rem] border  font-medium text-slate-800  bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-450 dark:text-navy-50 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90" style={{border:"dashed"}} id="btn1" alt="avatar" onClick={() => {
                                     this.setState({
                                      imageResizer : true
                                    })
                                }}>
                        ...
                        <label class="block">
                        <div class="  mx-auto"> 
                                {this.state.uplodedImagmobile?<><div className='pb-2'>Banner image for mobile (Size 524X100) </div><img class=" border h-20 w-25 bg-slate-200" src={this.state.uplodedImagmobile} alt="avatar" onClick={() => {
                                     this.setState({
                                      imageResizerMobile : true
                                    })
                                }}/></> :
                                <button class="btn h-20 min-w-[7rem] border  font-medium text-slate-800  bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-450 dark:text-navy-50 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90"  id="btn2" style={{border:"dashed"}} alt="avatar" onClick={() => {
                                     this.setState({
                                      imageResizerMobile : true
                                    })
                                }}>
            ...
            { this.state.step2 ? 
                <div class="card px-4 pb-4 sm:px-5">
                    ...
                    <div class="flex justify-center space-x-2 pt-4">
                        ...
                        <button class="btn min-w-[7rem] bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90" onClick={this.firstNext}
                        >Next</button>
                    </div>
                </div>
            : null
            ...
            { this.state.step4 ? 
                <div class="card px-4 pb-4 sm:px-5">
                    ...
                    <label class="block text-left">
                        ...
                        <input class="form-input mt-1.5 w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" type="text" id="title" onChange={this.handleInputChange}/>
                    </label>
                    <label class="block text-left">
                        <span>Voucher description</span>
                        <input class="form-input mt-1.5 w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" type="text" id="description" onChange={this.handleInputChange}/>
                    </label>
                    <div class="block text-left">
                        <label class="inline-flex items-center space-x-2">
                    ...
                    <div class="flex justify-center space-x-2 pt-4">
                        ...
                        >Pre</button>
                        <button class="btn min-w-[7rem] bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90" onClick={this.createVoucher}>Create Voucher</button>
                    </div>
                    </div>
                </div>
            : null
