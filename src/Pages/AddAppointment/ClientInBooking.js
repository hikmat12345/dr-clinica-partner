      ...
      <div className="bottom-secion-clients">
        <div>
          ...
          <div style={{ marginTop: "87px" }}>
            ...
            {!loading ? (
              <button
                onClick={submitByCheckOutExpress}
                className="btn mb-10 mr-2 px-1 py-3 space-x-2 bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90"
              >
                Express checkout
              </button>
            ) : (
              <button className="btn mb-10 mr-2 px-1 py-3 space-x-2 bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                Express checkout
                <img
                  style={{
                    width: "30px",
          ...
          <form className="space-x-6 p-6 text-left ">
            ...
            <label className="block" style={{ marginLeft: "0px" }}>
              ...
              <input
                ...
                id="phone"
                className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"
                placeholder="Example +971502223333"
              />
              {formErrors.phone && (
